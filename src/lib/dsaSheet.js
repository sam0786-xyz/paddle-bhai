    ...
    topics: [
      {
        ...
        problems: [
          { title: 'User Input / Output', difficulty: 'easy', link: '' },
          { title: 'Data Types', difficulty: 'easy', link: '' },
          { title: 'If-Else Statements', difficulty: 'easy', link: '' },
          { title: 'Switch Statement', difficulty: 'easy', link: '' },
          { title: 'Arrays/Strings Basics', difficulty: 'easy', link: '' },
          { title: 'For/While Loops', difficulty: 'easy', link: '' },
          { title: 'Functions', difficulty: 'easy', link: '' },
        ],
      },
      {
        name: 'Build-up Logical Thinking (Patterns)',
        problems: [
          { title: 'Pattern 1 – Rectangular Star', difficulty: 'easy', link: '' },
          { title: 'Pattern 2 – Right Triangle Star', difficulty: 'easy', link: '' },
          { title: 'Pattern 3 – Right Triangle Number', difficulty: 'easy', link: '' },
          { title: 'Pattern 4 – Right Triangle Number II', difficulty: 'easy', link: '' },
          { title: 'Pattern 5 – Inverted Right Triangle', difficulty: 'easy', link: '' },
          { title: 'Pattern 6 – Inverted Number Triangle', difficulty: 'easy', link: '' },
        ],
      },
      {
